...
<section class="section about-page">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				<p>Sistem pakar diagnosa penyakit usus merupakan sistem yang dibangun dan dikembangkan dengan tujuan untuk memudahkan
                    pasien melakukan konsutasi keluhan yang dimiliki pasien terkait penyakit pada bagian usus, sistem ini dirancang dengan menggunakan penerapan metode Naive Bayes. Penalaran yang digunakan 
